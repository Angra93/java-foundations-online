...
//        System.out.println("Salary.increaseCoeficient = " + Salary.increaseCoeficient);
        ...
        System.out.println("Salary.SEO = " + Salary.SEO);
        System.out.println();

        Car car = new Car("audi", "gray");
        Car car2 = new Car("bentley", "black");

        System.out.println("car.getCar() = " + car.getCar());
        System.out.println("car2.getCar() = " + car2.getCar());
    }
}
